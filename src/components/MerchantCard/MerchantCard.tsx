    ...
    <div className="Merchant" ref={ref}>
      ...
      <div className="Merchant--Details">
          <div className="Merchant--Details--Row">
              <p className="Merchant--Details--Item">{merchant.addressLine1}</p>
              <p className="Merchant--Details--Item">{merchant.phoneNumber}</p>
          </div>
          <div className="Merchant--Details--Row">
              <p className="Merchant--Details--Item">{merchant.addressLine2}</p>
              <a className="Merchant--Details--Link" href={merchant.websiteUrl}>Website</a>
          </div>
      </div>
